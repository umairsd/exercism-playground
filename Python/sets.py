...
def check_drinks(drink_name, drink_ingredients):
    ...
    if ingredients_set.intersection(ALCOHOLS):
...
def tag_special_ingredients(dish):
    ...
    special_ingredients_set = set(dish_ingredients).intersection(SPECIAL_INGREDIENTS)
...
def compile_ingredients(dishes):
    ...
    """
    master_set = set()
    for dish_ingredieents in dishes:
        master_set.update(dish_ingredieents)
    return master_set
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    ingredients_set = set(dishes)
    appetizers_set = set(appetizers)
    # return ingredients_set.difference(appetizers_set)
    return list(ingredients_set - appetizers_set)
...
def singleton_ingredients(dishes, intersection):
    ...
    return ingredients_set.difference(intersection)
